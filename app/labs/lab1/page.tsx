      ...
      <header className="border-b border-gray-200 bg-white sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-4 space-y-2">
            ...
            <h1 className="text-lg sm:text-xl font-semibold text-gray-900">Lab 1: Environment Setup & Project Introduction</h1>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="grid grid-cols-3 gap-4 p-4 bg-blue-50 border border-blue-200 rounded-lg mb-6">
            ...
            <div className="text-center">
              <div className="text-lg font-semibold text-blue-900">Next.js + Setup</div>
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <h2 className="text-2xl font-bold mt-10 mb-6 text-gray-900">Part A: Create Your Accounts</h2>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">1. GitHub Setup</h3>
...
git config --global --list`}</CodeBlock>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">2. Google Gemini API</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">3. AWS Account</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">4. Neon Database</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">5. Resend Email Service</h3>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-6 text-gray-900">Part B: Install Development Tools</h2>

          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">1. Node.js Installation</h3>
...
npm --version`}</CodeBlock>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">2. Python Installation</h3>
...
pip --version      # or pip3 --version`}</CodeBlock>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">3. Git Installation</h3>
...
brew install git`}</CodeBlock>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">4. Code Editor (Recommended)</h3>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-6 text-gray-900">Part C: Project Setup</h2>

          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">1. Fork Repository</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">2. Clone Your Fork</h3>
...
cd ai-solutions-lab`}</CodeBlock>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">3. Install Dependencies</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">4. Environment Configuration</h3>
...
DEBUG=true`}</CodeBlock>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">5. Run the Application</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4 text-gray-900">6. Test the Complete Flow</h3>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-6 text-gray-900">Troubleshooting & Next Steps</h2>
